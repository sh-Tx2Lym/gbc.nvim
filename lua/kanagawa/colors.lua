...
local palette = {
    ...
    rebeccaFg       = "#EEEEDD",
    rebeccaFgDim    = "#C8D4B8",
    rebeccaYellow   = "#C8DC60",
    rebeccaPaleYel  = "#E0EC90",
    rebeccaGreen    = "#78D066",
    rebeccaMutedGrn = "#50B898",
    rebeccaPink     = "#E87898",
    rebeccaPinkDim  = "#C06070",
    rebeccaCyan     = "#70D0CC",
    rebeccaOrange   = "#E8A050",
    rebeccaDim      = "#C8B0F0",
    rebeccaOlive    = "#A8B870",
    rebeccaDarkOl   = "#2A3818",
    rebeccaNearBlk  = "#0D0D0D",
    rebeccaVisual   = "#2A3810",
